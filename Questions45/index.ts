...
//Q3
let name2="Eric";
console.log("Hello",name2.toLowerCase());
...
//Q5
let message="Albert Einsteinonce said,“A person who never made a mistake never tried anything new.”";
console.log(message);
//Q6
let name: string = "\t Ali Hasan \n";
...
firstDigit=4;
secondDigit=4;
let sum8=firstDigit+secondDigit;
console.log(`"The Addition of,${firstDigit} +  ${secondDigit} is: ${sum8}"`);
firstDigit=2
let Multy8=firstDigit*secondDigit;
console.log(`"The Multiplication of ${firstDigit}*${secondDigit} is: ${Multy8}"`);
firstDigit=32
let Div8=firstDigit/secondDigit;
console.log(`"The Divisin of ${firstDigit}/${secondDigit} is: ${Div8}"`);
//Q8
console.log(5+3);
console.log(4+4);
console.log(6+2);
...
//Define favourite number
const fn:number=5;
//Embed the favourite number in a message
let msg=`My favourite number is :${fn}`
console.log(msg);
//Q10 I have added the comments in above example
//Q11
const Myfriends:string[]=["Ali","Hassan","Arshad"];
console.log(Myfriends[0]);
console.log(Myfriends[1]);
console.log(Myfriends[2]);
//Q12
console.log(`Hello My Friend,${Myfriends[0]}`);
console.log(`Hello My Friend,${Myfriends[1]}`);
console.log(`Hello My Friend,${Myfriends[2]}`);
//Q13
const ModeOfTrans:string[]=["Car","Motorcycle","Jeep"];
for(const Mode of ModeOfTrans){
    console.log(`I want to Own:${Mode}`);
}
//Q14
const GuestList:String[]=["Abid","Akbar","Akhtar"];
for(const guest of GuestList)
{
    console.log(`${guest} hope you will be alright,You are invited to dinner`);
}
